document.addEventListener('DOMContentLoaded', () => {
    ...
    if (heroSlideshow) {
        ...
        const nextBtn = heroSlideshow.querySelector('.slide-arrow.next');
        const prevBtn = heroSlideshow.querySelector('.slide-arrow.prev');
        const dots = heroSlideshow.querySelectorAll('.dot');
        let current = 0;
        let timer;
